...
WS2812, and MAX98357A. Add a 470-1000uF capacitor near the WS2812 strip and
...
line response, and only blinks red / plays the warning sound when the server
returns `label=angry`.

The default firmware plays a short alert tone. To use a real spoken prompt, make
a 16 kHz, 16-bit WAV file with the phrase "请保持距离，狗狗可能紧张" and run:
